...
def get_wedding_message(name, email):
    ...
    message["to"] = email
    message["subject"] = (
        "Wedding Ceremony Invitation: Samuel and Theodora - July 20th, 2024"
    )

    image_path = "ceremony-invitation.png"

    html_content = f"""
<!DOCTYPE html>
<html>
<head><title>Wedding Ceremony Invitation</title></head>
<body>
    <img 
        src="cid:image1" 
        style="
...
if __name__ == "__main__":
    ...
    pd.DataFrame.from_dict({"contacted_email": contacted_groups}).to_csv(
        "contacted_email.csv", index=False
    )
